...
void loop() {
  if( millis()-update_t >= INTERVAL_TIME ) {
    ...
    Serial.print("GET => https://"); Serial.println(URI);
    
    // ***** HTTPS ****
    // Https Get
    WiSEN.NBIoT.httpsGET(URI);
    // Or Https Get with port define
    //WiSEN.NBIoT.httpsGET(443, URI);
